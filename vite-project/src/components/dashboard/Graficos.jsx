  ...
  const data = [
    {
      ...
      value: reviews.filter(
        (r) => r.etiquetaId._id === "68e1b1b90cac8b39d1263ff3"
      ).length,
    },
    {
      name: "Comentario",
      value: reviews.filter(
        (r) => r.etiquetaId._id === "68e1b1b90cac8b39d1263ff5"
      ).length,
    },
    {
      name: "Recomendacion",
      value: reviews.filter(
        (r) => r.etiquetaId._id === "68e1b1b90cac8b39d1263ff4"
      ).length,
    },
    {
      name: "Resumen",
      value: reviews.filter(
        (r) => r.etiquetaId._id === "68e1b1b90cac8b39d1263ff7"
      ).length,
    },
  ];
